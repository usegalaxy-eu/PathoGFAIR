...
- Figure 2
	...
	- Panel (C) corresponds to a phylogenetic tree generated using Galaxy and available in this [Galaxy history](https://usegalaxy.eu/u/engy.nasr/h/samples-without-prior-isolation-all-amples) (step 11427)
...
- [Supplementary online Figure S2](https://usegalaxy.eu/datasets/4838ba20a6d867655a25cd6b8e403afc/display/?preview=True&dataset=0&node=0&collapse=true&color=false&depth=34&font=11&key=true)
- Supplementary Figure S3 generated by `bin/samples_without_prior_pathogen_isolation.ipynb`
- Supplementary Figure S4
	- Phylogenetic tree generated using Galaxy and available in this [Galaxy history](https://usegalaxy.eu/u/engy.nasr/h/samples-without-prior-isolation-all-amples) (step 11425)
...
- [Supplementary online Figure S6](https://usegalaxy.eu/datasets/4838ba20a6d867654eae2307be1421b5/display/?preview=True&dataset=0&node=0&collapse=true&color=false&depth=7&font=11&key=true)
...
- Supplementary Figure S8
	- Phylogenetic tree generated using Galaxy and available in this  [Galaxy history](https://usegalaxy.eu/u/engy.nasr/h/samples-with-prior-isolation-all-samples) (step 2742)
